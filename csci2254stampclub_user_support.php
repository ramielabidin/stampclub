 ...
 *
 * Member registration.
 * The user is registered with a CSCI2254_stampclub_role of scholar or collector 
 **/
...
//2. Add validation. In this case, we make sure firstname and lastname are required.
add_filter( 'registration_errors', 'csci2254stampclub_registration_errors' );
function csci2254stampclub_registration_errors( $errors ) {
